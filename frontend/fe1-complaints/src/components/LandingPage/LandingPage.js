...
import { FaShieldAlt, FaClock, FaHeadset } from "react-icons/fa"; // Import icons
...
const LandingPage = () => {
  ...
  <Button
    variant="primary"
    className="action-btn view-complaints-btn"
  ...
  <Button
    variant="success"
    className="action-btn submit-complaint-btn"
  ...
  <li className="fw-medium">
    ...
    Admin support for quicker resolution
                ...
                <p className="login-note">
                  ...
                  Use only your official @vnrvjiet.in college email address
                </p>
              </div>
            )}
          </Col>
