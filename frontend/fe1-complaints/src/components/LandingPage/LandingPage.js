...
const LandingPage = () => {
  const { user, loginWithSSO, switchRole } = useAuth();
          ...
          <Col md={6} className="content-col">
            ...
            {user ? (
              ...
              <div className="guest-section">
                {isExperimental ? (
                  <>
                    <h2 className="tagline">🧪 Experimental Demo Mode</h2>
                    <p className="description fw-medium">
                      Explore the platform by selecting a role below. No login required.
                    </p>

                    <div className="d-grid gap-3 mt-4" style={{ maxWidth: '400px' }}>
                      <Button
                        variant="outline-primary"
                        size="lg"
                        onClick={() => switchRole('student')}
                        className="py-3 text-start ps-4 position-relative"
                      >
                        🎓 <span className="ms-2 fw-bold">Student</span>
                        <small className="d-block text-muted ms-4 ps-1" style={{ fontSize: '0.85rem' }}>View, create, and track complaints</small>
                      </Button>
                      ...
                      >
                        ...
                        <small className="d-block text-muted ms-4 ps-1" style={{ fontSize: '0.85rem' }}>Resolve complaints & manage users</small>
                      </Button>
                      ...
                      <Button
                        ...
                        className="py-3 text-start ps-4 position-relative"
                      >
                        ⚡ <span className="ms-2 fw-bold">Super Admin</span>
                        <small className="d-block text-muted ms-4 ps-1" style={{ fontSize: '0.85rem' }}>Manage flags & oversight</small>
                      </Button>
                    </div>
                    <p className="login-note mt-4 text-center text-muted" style={{ fontSize: '0.8rem' }}>
                      * Data resets weekly. This is a simulation environment.
                    </p>
                  </>
                ) : (
                  <>
