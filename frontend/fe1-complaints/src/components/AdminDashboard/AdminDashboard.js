...
import ManageAssistants from "../ManageAssistants/ManageAssistants";
  ...
  return (
    <div className="p-5">
      ...
      <div className="flex space-x-4 mb-4">
        ...
        <button
          className={`px-4 py-2 rounded ${activeTab === "assistants" ? "bg-blue-500 text-white" : "bg-gray-200"
            }`}
      ...
      <div className="bg-white p-4 shadow rounded">
        {activeTab === "complaints" && <AdminPage />}
        {activeTab === "analysis" && <Analysis />}
        {activeTab === "assistants" && <ManageAssistants />}
      </div>
    </div>
  );
}
