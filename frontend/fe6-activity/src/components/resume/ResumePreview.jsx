                  ...
                  const previewData = isEditing ? {
                    ...
                    sections: (sections || []).filter(section => 
                      ...
                      if (isCustomSection) {
                        ...
                        const bullets = (section.entries || []).map(entry => entry.title).filter(title => title.trim() !== '');
                      ...
                      // For other sections, keep the standard format
                      return {
                        id: section.id,
                        title: section.title,
                        entries: section.entries || [],
                    ...
                    sectionOrder: sectionOrder || ['contact', 'summary', 'experience', 'education', 'skills', 'projects', 'co_curricular', 'extra_curricular', 'certifications', 'custom']
                  } : (resumeData || {
                    basics: {
                      name: '',
                      email: '',
                    ...
                    certifications: [],
                    sections: [],
                    sectionOrder: ['contact', 'summary', 'experience', 'education', 'skills', 'projects', 'co_curricular', 'extra_curricular', 'certifications', 'custom']
                  });
