...
const CustomTooltip = ({ active, payload, label }) => {
  ...
  return (
    ...
    >
      ...
      <Typography variant="body1" sx={{ color: '#2cbe4e', fontWeight: 'bold', mt: 0.5 }}>
        Rating: {rating?.toLocaleString() || 'N/A'}
      </Typography>
    </Box>
  );
};
              ...
              >
                ...
                <Box sx={{ 
                  ...
                  <ResponsiveContainer width="100%" height="100%">
                    <LineChart
                      data={leetcodeData?.contest_history
                        ?.map(contest => ({
                          ...contest,
                          date: new Date(contest.date * 1000).getTime(),
                          rating: contest.rating || 0 // Ensure rating is never undefined
                        }))
