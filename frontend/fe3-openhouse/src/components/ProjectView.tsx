...
import { Code2, Tags, MessageCircle, Trash, ThumbsUp, PlayCircle, ArrowLeft, Share2 } from 'lucide-react';
...
function ProjectView({ user, setUser }: ProjectViewProps) {
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            <main className="container mx-auto px-4 py-8 max-w-5xl">
                <button
                    onClick={() => navigate('/')}
                    className="flex items-center gap-2 text-gray-600 hover:text-emerald-600 mb-6 transition-colors font-medium"
                >
                    <ArrowLeft size={20} />
                    Back to Home
                </button>
                ...
                <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
                    ...
                    <div className="bg-white border-b border-gray-100 px-8 py-6 flex flex-col md:flex-row md:items-center justify-between gap-4">
                        ...
                        <span className="inline-block bg-gradient-to-r from-purple-50 to-indigo-50 px-4 py-1.5 rounded-full text-sm font-semibold text-gray-800 border border-indigo-100 self-start md:self-center">
                            {project.department}
                        </span>
                    </div>
                    ...
                    <div className="p-8 space-y-10">
                        ...
                        <div className="flex items-center gap-6 border-b border-gray-50 pb-6">
                            ...
                            <button
                                onClick={handleShare}
                                className="flex items-center gap-2 px-4 py-2 bg-gray-50 text-gray-600 rounded-xl hover:bg-gray-100 transition-all"
                            >
                                <Share2 size={22} />
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex gap-6 overflow-x-auto pb-4 snap-x custom-scrollbar">
                                {project.images.map((image, index) => (
                                    <div key={index} className="snap-center flex-shrink-0 group relative overflow-hidden rounded-2xl bg-gray-100 w-full md:w-[600px] h-[350px] flex items-center justify-center">
                                        <img
                                            src={image}
                                        ...
                                        <div className="bg-gray-50 rounded-2xl p-6 border border-gray-100 flex flex-col items-center gap-6">
                                            <div className="relative w-full aspect-[4/3] max-h-[600px] bg-white rounded-lg overflow-hidden shadow-inner">
                                                ...
                                                <button
                                                    ...
                                                    className="absolute left-4 top-1/2 -translate-y-1/2 p-2 bg-white/90 rounded-full shadow-lg hover:bg-emerald-50 text-emerald-600 disabled:opacity-50"
                                                    disabled={pdfPage === 1}
                                                >
                                                    <ArrowLeft size={24} />
                                                </button>
                                                <button
                                                    ...
                                                    className="absolute right-4 top-1/2 -translate-y-1/2 p-2 bg-white/90 rounded-full shadow-lg hover:bg-emerald-50 text-emerald-600"
                                                >
                                            ...
                                            <div className="flex items-center gap-4">
                                                ...
                                                <button
                                                    className="px-6 py-2 bg-emerald-600 text-white rounded-xl hover:bg-emerald-700 shadow-lg shadow-emerald-200 transition-all font-medium"
                            ...
                            <div className="space-y-8">
                                <section className="bg-gray-50 rounded-2xl p-6 border border-gray-100">
                                    ...
                                    <div className="space-y-6">
                                        <div>
                                            <h4 className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-2">Team Members</h4>
                                        ...
                                        {project.mentor && (
                                            <div>
                                                <h4 className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-2">Mentor</h4>
                            ...
                            <div className="max-w-3xl space-y-8">
                                <div className="space-y-4">
                                    <textarea
                                        ...
                                        rows={4}
                                        className="w-full p-4 bg-gray-50 border border-gray-200 rounded-2xl focus:ring-2 focus:ring-emerald-500 focus:bg-white placeholder-gray-400 resize-none transition-all outline-none"
                                    ...
                                    {!user && <p className="text-sm text-red-500 text-right font-medium">Please login to comment</p>}
                                </div>
                                            ...
                                            <div key={comment.id} className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
                                                <div className="flex justify-between items-start mb-2">
                                                    <div>
                                                        ...
                                                        <p className="text-[10px] text-gray-400 uppercase tracking-widest">{formatDateToIST(comment.created_at)}</p>
                                                    </div>
